...
1. Choose the Workflow Type as **Autonomous Agents** and click on create.

   ![Screenshot shows an example of create Logic App blade](media/01-create-first-autonomous-agent/create-workflow-consumption.png)
...
Always prioritize clarity and brevity in summaries.
````
![Screenshot shows prompt for autonomous workflow](media/01-create-first-autonomous-agent/workflow-add-prompt-consumption.png)
