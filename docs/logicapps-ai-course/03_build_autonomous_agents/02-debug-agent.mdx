...
## Prerequisites
- Completed agent created on [01 - Create your first autonomous agent in Azure Logic Apps](./01-create-first-autonomous-agent.mdx) module.
...
1. On the Run history page, in the runs table, select the latest workflow run.
    ...
    ![Screenshot shows the run history for the workflow](media/02-debug-agent/logicapp-run-history-consumption.png)
