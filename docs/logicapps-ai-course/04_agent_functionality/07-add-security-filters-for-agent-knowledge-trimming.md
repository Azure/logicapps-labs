...
> - You have uploaded interns and employees folder to the container in your Azure Storage Account resource. The folders used in this module can be downloaded here: [employees folder in zip format](/logicapps-ai-course/employees.zip) and [interns folder](/logicapps-ai-course/interns.zip) in the container in your Azure Storage Account resource.
